package Exercicios.Ex2.view;

public class Principal {

	public static void main(String[] args) {
		//file:///C:/Users/kaioi/Google%20Drive/ADS/Fatec/4%20semestre/S.O/Exercicio_Processos.pdf
		/*
		 * Ex. 2
			...
			A aplicação deverá ter, no package view,
			uma classe que tenha um método main que dê ao usuário 
			a possibilidade de ver os processos ativos ou matar os processos (Por Nome ou PID).
